...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 left-1/2 z-[100] flex w-[calc(100%-1rem)] max-h-screen -translate-x-1/2 flex-col-reverse gap-2 p-2 pb-[calc(.5rem+env(safe-area-inset-bottom))] sm:right-4 sm:left-auto sm:w-full sm:max-w-[420px] sm:translate-x-0 sm:flex-col",
      className
    )}
    {...props}
  />
